	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-4 col-xs-6">
				<div class="shop">
					<div class="shop-img">
						<img src="/assets/img/1so1.jpg" alt="">
					</div>
					<div class="shop-body">
							...
							<div class="products-slick" data-nav="#slick-nav-1">
								...
								<div class="product">
									<div class="product-img">
										<img src="/assets/img/iphone12.png" alt="">
			...
			<div class="col-md-12">
				<div class="newsletter">
					...
					<ul class="newsletter-follow">
						<li>
							<a href="https://www.facebook.com/tran.henry.3323"><i class="fa fa-facebook"></i></a>
						</li>
						<li>
							<a href="https://twitter.com/?lang=vi"><i class="fa fa-twitter"></i></a>
						</li>
						<li>
							<a href="https://www.instagram.com/vietnamese.sexy.girl/"><i class="fa fa-instagram"></i></a>
						</li>
						<li>
							<a href="https://www.pinterest.com/pin/9781324183626935/"><i class="fa fa-pinterest"></i></a>
						</li>
					</ul>
				</div>
			</div>
